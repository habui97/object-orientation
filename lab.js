...
let favoriteThings = {
  ...
  food : 'Tacos',
  person : 'Bad Bunny',
  book : 'To Kill the MockingBird',
  movie : 'Avengers',
  holiday : 'Cancun',
}
let {band: firstBand, person} = favoriteThings;
let {holiday: bestHolidayEver} = favoriteThings;
console.log(firstBand, person, bestHolidayEver);
...
console.log(`this ${color} ${make} ${model} was made in ${year}`);
...
let syby = new Cat('Syby', 2, 'white')
console.log(syby.name)
...
// let samsung = new Phone('SamSung', 'Galaxy', '128GB', 'White', 900);
// samsung.sell()
...
let phoneOne = new Phone('Apple', 'Iphone', '56GB', 'Pink', 1000);
let phoneTwo = new Phone('SamSung', 'Galaxy', '128GB', 'White', 900);
let phoneThree = new Phone('Pixel', 'Pixel2', '258GB', 'Black', 1200);
...
let toyota = new Vehicle('20', 'black', '1000')
toyota.move(2000)
console.log(toyota)
...
let myFirstVehicle = new Vehicle('10', 'red', '5000')
...
let myFirstMotorcycle = new Motorcycle(2, 'black', 2000, 'Ducati', true)
...
let myFirstBoat = new Boat(100, 'Silver', 5000, 'Ruz', 'Tug', false)
